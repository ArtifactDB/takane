...
TEST_F(GmtFileTest, Strict) {
    ...
    takane::gmt_file::strict_check = [](const std::filesystem::path&, const takane::ObjectMetadata&, const takane::Options&) { throw std::runtime_error("ARGH"); };
    expect_error("ARGH");
    takane::gmt_file::strict_check = nullptr;
}
