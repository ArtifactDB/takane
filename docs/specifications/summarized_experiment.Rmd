...
The top-level object in the `OBJECT` file should contain a `summarized_experiment` property, 
...
where the number of dimensions is at least 2 and the first two dimensions are equal to that of the summarized experiment.
