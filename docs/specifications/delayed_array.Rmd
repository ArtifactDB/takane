...
The value of this dataset holds an index to an external array.
...
The referencing custom array should have dimensionality (and type) consistent with that of the child object.
