...
The `compressed_sparse_matrix` format provides an on-disk representation of a sparse matrix in the compressed sparse row/column formats.
...
Missing values are represented by placeholder values, defined in the `missing-value-placeholder` attribute of the `compressed_sparse_matrix/data` dataset.
All values in the dataset equal to the placeholder should be treated as missing.
The placeholder datatype should be identical to that of `compressed_sparse_matrix/data`.
