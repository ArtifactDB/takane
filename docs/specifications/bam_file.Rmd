...
The `bam_file` format specifies the expected directory organization for BAM files.

## Metadata

The top-level object in the `OBJECT` file should contain an `bam_file` property.
