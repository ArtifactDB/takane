...
The top-level object in the `OBJECT` file should contain an `dense_array` property.
...
The height of the dense array is defined as the extent of the first dimension in `dense_array/data`.
If the array is transposed, the extent of the last dimension is used instead.

## Dimensions

The dimensions of the dense array are defined as the dimensions of `dense_array/data`.
