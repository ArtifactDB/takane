...
The `gff_file` format specifies the expected directory organization for GFF files.

## Metadata

The top-level object in the `OBJECT` file should contain an `gff_file` property.
