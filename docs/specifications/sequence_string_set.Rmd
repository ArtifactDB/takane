...
The top-level object in the `OBJECT` file should contain a `sequence_string_set` property.
...
in addition, each quality string should not contain characters below some threshold character.
