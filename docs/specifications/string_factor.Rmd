...
The top-level object in the `OBJECT` file should contain a `string_factor` property.
...
The height of the data frame is defined as the extent of the sole dimension of `string_factor/codes`.
