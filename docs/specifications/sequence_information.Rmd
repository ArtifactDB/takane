...
The top-level object in the `OBJECT` file should contain a `sequence_information` property.
...
- `length`, a dataset of any datatype that can be exactly represented by a 64-bit signed integer.
...
- `genome`, a dataset of any HDF5 string datatype, containing the identifier of the genome that contains the sequence.
  This may be duplicated across sequences.
